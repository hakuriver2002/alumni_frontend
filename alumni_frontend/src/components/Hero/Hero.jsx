      ...
      <div className="absolute inset-0 flex items-center justify-center text-white">
        <div className="text-center">
          <h1 className="text-6xl font-bold mb-4 mt-10 ">
            <span className="text-blue-500">MEETING</span>{" "}
          ...
          <div className=" text-white rounded-lg shadow-md px-6 py-8 m-28">
            ...
            <button className="mt-4 px-8 py-3 text-white font-bold rounded-md
             bg-blue-400 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 text-sm lg:px-5  lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-blue-400 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-blue-300">
